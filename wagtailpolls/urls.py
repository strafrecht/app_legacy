...
urlpatterns = [
    # Choosers
    re_path(r'^choose/$', chooser.choose,
    ...
    # General Urls
    re_path(r'^$', chooser.index,
        name='wagtailpolls_index'),
    re_path(r'^search/$', chooser.search,
        name='wagtailpolls_search'),
    re_path(r'^create/$', editor.create,
        name='wagtailpolls_create'),
    re_path(r'^edit/(?P<poll_pk>.*)/$', editor.edit,
        name='wagtailpolls_edit'),
    re_path(r'^delete/(?P<poll_pk>.*)/$', editor.delete,
        name='wagtailpolls_delete'),
    re_path(r'^copy/(?P<poll_pk>.*)/$', editor.copy,
        name='wagtailpolls_copy'),
    re_path(r'^results/(?P<poll_pk>.*)/$', results.results,
